import pandas as pd
def crear_tabla_comunas3(archivo):
    try:
        # Crear lista con los tipos de establecimientos únicos
        tipos_establecimiento = archivo[archivo['TIPO_ESTABLECIMIENTO'].isin(['SUR','SAR' ,'SAPU','MODULO_DENTAL'])]['TIPO_ESTABLECIMIENTO'].unique()
        ...
        tablasAfectacionC['principalComunas 3'] = principalAfectacionC
