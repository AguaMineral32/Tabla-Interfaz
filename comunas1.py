import pandas as pd
def crear_tabla_comunas1(archivo):
    try:
        # Crear lista con los tipos de establecimientos únicos
        tipos_establecimiento = archivo[archivo['TIPO_ESTABLECIMIENTO'].isin(['HOSPITAL','CENTRO_REGULADOR_SAMU' ,'BASE_SAMU'])]['TIPO_ESTABLECIMIENTO'].unique()
        ...
        tablasAfectacionC['principalComunas 1'] = principalAfectacionC
